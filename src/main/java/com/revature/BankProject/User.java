...
public class User implements Comparable<User> {
	...
	User(char userType, char userStatus, int userID, String userName, String userPass, String extraNoteIn) {
		type = userType;
		status = userStatus;
		ID = userID;
		name = userName;
...
//					System.out.print(columnValue + " " + rsmd.getColumnName(i));
	...
	public boolean isValid() {
		if (type == 'x' || status == 'x' || ID == -1 || name.equals("-1")
				|| password.equals("-1"))
			return false;
		else return true;
	}
	...
	public String toString() {
		String ret = "id: " + ID + ",  name: " + name + ",\t  password: " + password + ",  type: " + type + ",  status: "
				+ status + ",   note: " + extraNote;
